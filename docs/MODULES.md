...
- Назначение: запись итогового Excel (`.xlsx`) или CSV (`.csv`) с очисткой лишних колонок, объединением дублей, форматированием дат `ДД.ММ.ГГГГ` и группировкой столбцов (с разделителями и сворачиванием/разворачиванием в Excel).
