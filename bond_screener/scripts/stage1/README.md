...
- справочник эмитентов грузится страницами по `emitents_page_size`;
- на случай нестабильного API цикл ограничен `emitents_max_pages` и защитой от повторяющейся страницы.
